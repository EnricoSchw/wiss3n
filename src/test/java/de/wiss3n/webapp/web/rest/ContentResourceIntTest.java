...
public class ContentResourceIntTest {
     ...
     *
     * @see de.wiss3n.webapp.repository.search.ContentSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createContent() throws Exception {
        ...
        assertThat(testContent.getDate()).isEqualTo(DEFAULT_DATE);
    ...
    public void updateContent() throws Exception {
        ...
        reset(mockContentSearchRepository);
        ...
        assertThat(testContent.getDate()).isEqualTo(UPDATED_DATE);
