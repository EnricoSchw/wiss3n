...
import de.klassenchat.webapp.config.audit.AuditEventConverter;
import de.klassenchat.webapp.domain.PersistentAuditEvent;
...
import static de.klassenchat.webapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
