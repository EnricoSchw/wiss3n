...
import { TeachingSubjectComponent } from 'app/entities/teaching-subject/teaching-subject.component';
...
describe('Component Tests', () => {
    describe('TeachingSubject Management Component', () => {
        let comp: TeachingSubjectComponent;
        let fixture: ComponentFixture<TeachingSubjectComponent>;
        let service: TeachingSubjectService;
        const mockTeachingSubjectService = {query: () => null};
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(TeachingSubjectComponent, '')
                .compileComponents();
