...
describe('Service Tests', () => {
    ...
    describe('ContentClassApp Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ContentClassAppService);
        ...
        describe('Service methods', () => {
            ...
            it('should return ContentClassApp', () => {

                let entity: ContentClassApp;
                service.find(123).subscribe((_entity: ContentClassApp) => {
                    entity = _entity;
                });
