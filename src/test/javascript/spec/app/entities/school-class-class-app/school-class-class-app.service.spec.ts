...
describe('Service Tests', () => {
    ...
    describe('SchoolClassClassApp Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(SchoolClassClassAppService);
        ...
        describe('Service methods', () => {
            ...
            it('should return SchoolClassClassApp', () => {

                let entity: SchoolClassClassApp;
                service.find(123).subscribe((_entity: SchoolClassClassApp) => {
                    entity = _entity;
                });
