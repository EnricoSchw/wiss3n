...
describe('Service Tests', () => {
    ...
    describe('TaskClassApp Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(TaskClassAppService);
        ...
        describe('Service methods', () => {
            ...
            it('should return TaskClassApp', () => {

                let entity: TaskClassApp;
                service.find(123).subscribe((_entity: TaskClassApp) => {
                    entity = _entity;
                });
