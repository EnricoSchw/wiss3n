...
describe('Service Tests', () => {
    ...
    describe('GradeClassApp Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(GradeClassAppService);
        ...
        describe('Service methods', () => {
            ...
            it('should return GradeClassApp', () => {

                let entity: GradeClassApp;
                service.find(123).subscribe((_entity: GradeClassApp) => {
                    entity = _entity;
                });
