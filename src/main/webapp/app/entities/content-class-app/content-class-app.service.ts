...
export class ContentClassAppService {
    ...
    create(content: ContentClassApp): Observable<ContentClassApp> {
    ...
    update(content: ContentClassApp): Observable<ContentClassApp> {
        const copy = this.convert(content);
    ...
    find(id: number): Observable<ContentClassApp> {
     ...
     */
    private convertItemFromServer(json: any): ContentClassApp {
        const entity: ContentClassApp = Object.assign(new ContentClassApp(), json);
        return entity;
    }
