...
export class TeachingSubjectComponent implements OnInit, OnDestroy {
    ...
    transition() {
        this.router.navigate(['/teaching-subject'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: ITeachingSubject) {
        return item.id;
    }
    ...
    private paginateTeachingSubjects(data: ITeachingSubject[], headers: HttpHeaders) {
