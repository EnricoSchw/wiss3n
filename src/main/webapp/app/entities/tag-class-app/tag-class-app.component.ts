...
@Component({
    selector: 'jhi-tag-class-app',
    templateUrl: './tag-class-app.component.html'
})
export class TagClassAppComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.tagService.query({
            ...
            (res: HttpResponse<TagClassApp[]>) => this.onSuccess(res.body, res.headers),
    ...
    trackId(index: number, item: TagClassApp) {
        return item.id;
    }
