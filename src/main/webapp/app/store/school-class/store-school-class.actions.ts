...
export enum SchoolClassActionTypes {
    ...
    ActivateSchoolClass = '[SchoolClass] Activate SchoolClass',
}
...
export class ActivateSchoolClass implements Action {
    readonly type = SchoolClassActionTypes.ActivateSchoolClass;
